...
export default function SelectAccountType({ value, label, options, onChange }: Props) {
  ...
  return (
    <main>
      <label htmlFor="select-account-type" className="block text-sm font-medium leading-6 text-gray-300">
        {label}
      </label>
      <div className="mt-2">
        <select
          ...
          value={value}
          autoComplete="select-account-type"
